  ...
  public class ItemController : BaseController
  {
    ...
    public async Task<IActionResult> Create(CreateItemViewModel model)
    {
      ...
      Item item = new Item()
      {
        ...
        CreditAccountId = model.SelectedDebitAccountId,
        DebitAccountId = model.SelectedCreditAccountId,
      ...
      int pageSize = 2)
    {
      ...
      ItemViewModel ConvertToViewModel(Item item)
      {
        var viewModel = new ItemViewModel
        {
          ...
          RevenueAccountId = item.CreditAccountId,
          AssetsAccountId = item.DebitAccountId,
