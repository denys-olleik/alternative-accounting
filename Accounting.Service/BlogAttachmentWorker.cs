...
//        {
//          var BlogAttachmentVariantService = new BlogAttachmentVariantService(
//            tenant.DatabaseName,
//            tenant.DatabasePassword);

//          // Fetch oldest queued variant (atomic status update inside manager)
//          BlogAttachmentVariant? blogAttachmentVariant = await BlogAttachmentVariantService.GetOldestAsync(
//            BlogAttachmentVariant.StateConstants.Queued);

//          if (blogAttachmentVariant == null)
//            continue;

//          foreach (var kvp in blogAttachmentVariant.TranscodeStatus) // iterate variants
//          {
...
//              Path.GetDirectoryName(blogAttachmentVariant.FilePath)!,
...
//              variantKey,
//              blogAttachmentVariant.FilePath,
//              variantStatus.VariantPath!,
//              progressFilePath);
